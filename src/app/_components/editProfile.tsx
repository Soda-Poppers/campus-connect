...
import { X, Plus, Camera, Save, ChevronDown, ChevronUp } from "lucide-react";
...
const EditProfileModal: React.FC<Props> = ({
  ...
  const addSkill = () => {
    if (newSkill.trim()) {
      ...
      if (
        ...
        !currentSkills.some(
          (skill: Skill) => skill.skillName === newSkill.trim(),
        )
      ) {
        setFormData((prev: UserProfile) => ({
          ...prev,
  ...
  const addInterest = () => {
    if (newInterest.trim()) {
      ...
      if (
        interests.length < 5 &&
        !interests.some(
          (interest: Skill) => interest.skillName === newInterest.trim(),
        )
      ) {
        setFormData((prev: UserProfile) => ({
          ...prev,
  ...
  const SectionHeader: React.FC<SectionHeaderProps> = ({
    ...
    <div className="border-border rounded-lg border">
      <button
        ...
        className="hover:bg-muted/50 flex w-full items-center justify-between rounded-t-lg p-4 text-left transition-colors"
      >
  ...
  const getSocialValue = (platform: string): string => {
    return (
      formData.socialMedia?.find((s) => s.platform === platform)?.username ?? ""
    );
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="mx-auto flex h-[90vh] max-w-md flex-col p-0">
        <DialogHeader className="p-4">
          ...
          <DialogDescription className="sr-only">
            ...
            modules, interests, and social profiles
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex-1 space-y-4 overflow-y-auto p-4">
          ...
          <div className="text-center">
            <div className="relative inline-block">
              ...
              <button className="bg-primary border-background absolute right-0 bottom-0 flex h-8 w-8 items-center justify-center rounded-full border-2">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="border-input bg-background text-foreground focus:ring-primary w-full rounded-md border p-2 focus:border-transparent focus:ring-2 focus:outline-none"
                >
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("enrollmentYear", e.target.value)
                  }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("intro", e.target.value.slice(0, 100))
                  }
          ...
          <SectionHeader title="Skills" section="skills">
            <div className="space-y-4">
              ...
              <div>
                <Label>
                  Soft Skills ({(formData.softSkills ?? []).length}/5)
                </Label>
              ...
              <div>
                <Label>
                  Hard Skills ({(formData.hardSkills ?? []).length}/5)
                </Label>
                <div className="mt-2 flex flex-wrap gap-2">
                  {(formData.hardSkills ?? []).map((skill, index) => (
                    ...
                    >
                      {skill.skillName}
                      <button
                        onClick={() => removeSkill(index, "hard")}
                        className="ml-2"
                      >
                        <X className="h-3 w-3" />
                      </button>
          ...
          <SectionHeader title="Current Modules" section="modules">
            <div className="space-y-4">
              ...
              <Button
                ...
                variant="outline"
                className="h-auto w-full border-dashed p-3"
              >
        ...
        <div className="border-border border-t p-4">
          <div className="flex space-x-3">
            ...
            <Button onClick={handleSave} className="bg-primary flex-1">
        ...
        <Dialog open={showModuleDialog} onOpenChange={setShowModuleDialog}>
          <DialogContent className="mx-auto max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingModule
                  ? "Update your module information"
                  : "Add a new module to your profile"}
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewModule((prev) => ({ ...prev, prof: e.target.value }))
                  }
