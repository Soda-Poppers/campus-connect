...
const ForumPage = () => {
  ...
  const [posts, setPosts] = useState([
    {
      ...
      description:
        "Building a full-stack e-commerce platform for my IS module. Need someone experienced with React and Node.js. Project duration: 4 weeks.",
      author: {
        name: "Sarah Chen",
        year: "Year 3",
        avatar: "",
    ...
    },
    {
      ...
      description:
        "Anyone wants to form a study group for Statistics? We can meet weekly to discuss concepts and practice problems together.",
      author: {
        name: "Marcus Lim",
        year: "Year 2",
        avatar: "",
    ...
    },
    {
      ...
      description:
        "Working on a social networking app and need an iOS developer to join the team. This is for a real startup, not just a school project!",
      author: {
        name: "Alex Wong",
        year: "Year 4",
        avatar: "",
    ...
    },
    {
      ...
      description:
        "Looking for teammates for the upcoming SMU ML competition. Need people with Python and data science experience.",
      author: {
        name: "Emily Tan",
        year: "Year 3",
        avatar: "",
  ...
  const generatePresetMessage = (post: {
    id?: number;
    title: string;
    description?: string;
    author: Author;
...
${senderName}`;
  ...
  return (
    <div className="container-sm safe-area-top mx-auto h-full overflow-y-auto">
      <div className="space-y-4 p-4">
        {/* Header */}
        <div className="flex items-center justify-between">
          <h1 className="text-primary text-xl font-bold">Forum</h1>
        ...
        {filteredPosts.length === 0 && (
          <div className="py-12 text-center">
            ...
            <h3 className="text-primary mb-2 font-medium">No posts found</h3>
